...
- Jest test suite (5 tests)
- CI/CD via GitHub Actions (test matrix on Node 14/16/18, publish to npm on tag)

[1.0.0]: https://github.com/artusm/nuxt-2-spa-cache-fix-module/releases/tag/v1.0.0
